function GvMoverNYC_changeNumStations
% comparing Greedy and Matching at SF dataset

load('nyc_sub_station_feasible', 'stationArray')
...
for i = numStationsToTest
    ...
    i
    [positive_gla_mul, negative_gla_mul] = GLA_multiRound(round(stationArray(50-i+1:end,4)*0.15),stationArray(50-i+1:end,4),-stationArray(50-i+1:end,5:28)+stationArray(50-i+1:end,29:52));    
    [positive_1ga_mul, negative_1ga_mul, feasible] = kGA_multiRound(round(stationArray(50-i+1:end,4)*0.15),stationArray(50-i+1:end,4),-stationArray(50-i+1:end,5:28)+stationArray(50-i+1:end,29:52),1);
...
%         negative = negative(negative(:,3)~=0,:);
    ...
    index = index+1;
    %disp(i);
    save('GvMoverNYC_800m_20_uniform_2.mat');
end
end
